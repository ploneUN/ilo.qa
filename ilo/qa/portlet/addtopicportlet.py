...
class IContentNavigation(IPortletDataProvider):
    ...
    button_description = schema.TextLine(
            title = u"Add Topic Button Label",
            required=False,
        )
...
class Assignment(base.Assignment):
    ...
    @property
    def title(self):
        return "Add Topic Button Portlet"
    

class Renderer(base.Renderer):
    render = ViewPageTemplateFile('templates/addtopicportlet.pt')
